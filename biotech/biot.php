    ...
    <main>
        <section class="container mt-5">
            <div class="page-header">
                <h1 class="display-5 text-center">Welcome to Biotechnology Department Equipment Booking System</h1>
                <u>
                    <h2 class="text-center mt-4">Biotechnology Department Equipments List</h2>
                </u>
            </div>
